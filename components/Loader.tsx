...
// type LoaderProps = {
//   /** Kleiner Spinner (true) oder normal (false) */
//   small?: boolean;
//   /** Optionaler Text rechts neben dem Spinner */
//   label?: string;
//   /** Zentrieren im Block (true) oder inline rendern (false) */
//   center?: boolean;
// };

// export default function Loader({ small = false, label, center = true }: LoaderProps) {
...
//       {label ? <span className="ml-3 text-sm text-gray-600">{label}</span> : null}
//     </div>
//   );
// }
